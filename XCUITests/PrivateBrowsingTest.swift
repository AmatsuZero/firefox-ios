...
class PrivateBrowsingTest: BaseTestCase {
    ...
    func testPrivateTabDoesNotTrackHistory() {
        ...
        XCTAssertTrue(history == 1, "History entries in regular browsing do not match")
        ...
        XCTAssertTrue(privateHistory == 1, "History entries in private browsing do not match")
    }
    ...
    func testTabCountShowsOnlyNormalOrPrivateTabCount() {
        ...
        navigator.nowAt(NewPrivateTabScreen)
        navigator.goto(PrivateTabTray)
    ...
    func testClosePrivateTabsOptionClosesPrivateTabs() {
        ...
        navigator.nowAt(PrivateTabTray)
        navigator.goto(SettingsScreen)
